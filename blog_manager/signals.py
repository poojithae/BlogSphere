...
#             #         # Send the custom signal after saving
#             #         custom_signal.send(sender=self.__class__, first_name=self.first_name, last_name=self.last_name)
#             #     #custom_signal.send(sender=Self.__class__, first_name='pooji', last_name='tha')
